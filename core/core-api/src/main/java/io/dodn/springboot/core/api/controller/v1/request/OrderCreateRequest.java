...
public record OrderCreateRequest(
	...
	public OrderCreateServiceRequest toServiceRequest() {
		return new OrderCreateServiceRequest(
			this.userEmail,
			this.productDTOS.stream().map(orderCreateRequestProductDTO ->
				new OrderCreateServiceRequest.productDTO(
					orderCreateRequestProductDTO.productNumber,
					orderCreateRequestProductDTO.quantity
				)
			).toList()
		);
